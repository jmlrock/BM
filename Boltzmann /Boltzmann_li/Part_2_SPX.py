...
#plt.title('QQ plot')
#plt.savefig('./Output/Part_2_SPX_2_QQPlot.pdf', format = 'pdf', dpi = 1000, bbox_inches = 'tight', pad_inches = 0)
...
plt.legend()
plt.title('Histogram')
plt.savefig('./Output/Part_2_SPX_3_HistPlot.pdf', format = 'pdf', dpi = 1000, bbox_inches = 'tight', pad_inches = 0)
...
for ind in tqdm([10, 1000, 10000]):
    ...
    plt.legend()
    plt.savefig('./Output/Part_2_SPX_1_Hist_N=' + str(ind) + '.pdf', format = 'pdf', dpi = 1000, bbox_inches = 'tight', pad_inches = 0)

    '## Graph: Comparaison QQ-Plots ##'    
    plt.figure()
    ...
    plt.ylabel('Reconstruction')
    plt.title('QQ plot')
    plt.savefig('./Output/Part_2_SPX_2_QQPlot_N=' + str(ind) + '.pdf', format = 'pdf', dpi = 1000, bbox_inches = 'tight', pad_inches = 0)
